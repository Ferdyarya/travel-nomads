                    ...
                    <div class="card card-details">
                        ...
                        <div class="attendee">
                            <table class="table table-responsive-sm text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td><img src="{{ url('frontend/images/avatar1.png')}}" height="60px"></td>
                                        <td class="align-middle">Angga Rizky</td>
                                        <td class="align-middle">CN</td>
                                        <td class="align-middle">N/A</td>
                                        <td class="align-middle">Active</td>
                                        <td class="align-middle"> <a href=""><img src="frontend/images/remove.png" alt=""></a></td>
                                    </tr>

                                    <tr>
                                        <td><img src="{{ url('frontend/images/avatar2.png')}}" height="60px"></td>
                                        <td class="align-middle">Galih Pratama</td>
                                        <td class="align-middle">SG</td>
                                        <td class="align-middle">30 Days</td>
                                        <td class="align-middle">Active</td>
                                        <td class="align-middle"> <a href=""><img src="{{ url('frontend/images/remove.png')}}" alt=""></a></td>
                                    </tr>                                            
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="card card-details card-right">                                
                    ...
                    <div class="bank">
                        <div class="bank-item pb-3">
                            <img src="{{ url('frontend/images/ic_bank.jpg')}}" alt="" class="bank-image">
